...
[[ ! -e "/bin/ShellBot.sh" ]] && wget -O /bin/ShellBot.sh https://gist.githubusercontent.com/drowkid01/92cc41167ca93dbb6732232ee6f33697/raw/edc7ed81cd1c7bd97f830b187bd25c0cb7d096a3/ShellBot.sh &> /dev/null
...
MSG_id=$((${message_message_id} + 1 ))
	[[ ! -z ${callback_query_message_chat_id[$id]} ]] && var=${callback_query_message_chat_id[$id]} || var=${message_chat_id[$id]}
	local bot_retorno="${bienvenida_gen}\n"
		bot_retorno+="$LINE\n"
